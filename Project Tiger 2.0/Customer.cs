...
namespace Project_Tiger_2._0
{
    public class Customer : Users
    {
...

        {
            ...
            while (logOut == false)
            {
                ...
                switch (choice)
                {
                    ...
                    case "4":
                        listOfCustomers[loggedInUserIndex].CreateNewBankAccount("BIT","TestAccountName",5000);
                        break;

                    case "5":
                        listOfCustomers[loggedInUserIndex].RemoveExistingBankAccount(0);
                        break;
                    ...
                    case "8":
                        listOfCustomers[loggedInUserIndex].DepositMoneyToAccount(0,5000);
                        break;
        ...
        public void CreateNewBankAccount(string currency, string accountNameTest,int amount) // Skapa nytt bankkonto
        {
            //Console.Clear();
            ...
            listOfBankAccounts.Add(new BankAccounts(accountNameTest, 0, currency));
        ...
        public void RemoveExistingBankAccount(int choosenAccount) // Ta bort ett bankkonto
        {
        ...
        public void DepositMoneyToAccount(int accountChoice, decimal amount)
        {
            //Console.Clear();
            //bool loop = true;
            //int accountChoice = 0;
